...
const CreateStudent = () => {
  const postStudent = async (val) => {
    const response = await axiosInstance.post("/student/public/register", val);
  ...
  const postStudentMutation = useMutation({
  ...
  return (
    <section className="w-full max-w-[1200px] mx-auto p-2 font-outfit">
      ...
      <h1 className="text-3xl mt-4">Create Your Students here</h1>
        ...
        <article className="p-3 w-full max-w-[350px] shadow-xl rounded-2xl">
          ...
          <Formik
            ...
            onSubmit={(val, { resetForm }) => {
              console.log(val);
              postStudentMutation.mutate(val, {
                onSuccess: () => {
              ...
              return (
                <Form>
                  ...
                  <div className="mt-9 flex justify-center items-center">
                    ...
                    >
                      Add Student
                      {postStudentMutation.isLoading && <Loader />}
                    </button>
                  </div>
                </Form>
              );
